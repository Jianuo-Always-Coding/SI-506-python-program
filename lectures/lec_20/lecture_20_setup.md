...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_20/
cp lecture_20_setup.md lecture_20.md lecture_20.py swapi_get_test.py ../Documents/umich/courses/SI506/lectures/lecture_20/
cd ../Documents/umich/courses/SI506/lectures/lecture_20/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_20`.

3. Copy (`cp`) the downloaded files to the `lecture_20` directory.
...
4. Navigate (`cd`) to your `lecture_20` directory.

5. Confirm "that the contents of the `lecture_20` directory are as expected (i.e., it contains
...
1. Hover over `lecture_20.md`, right-click, and select "Open Preview".
2. Hover over `lecture_20.py`, right-click, and select "Open to the Side".
