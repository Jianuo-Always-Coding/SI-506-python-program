...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_24/
cp lecture_24_setup.md lecture_24.md lecture_24.py lecture_24_utils.py films.json planets.json ../Documents/umich/courses/SI506/lectures/lecture_24/
cd ../Documents/umich/courses/SI506/lectures/lecture_24/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_24`.

3. Copy (`cp`) the downloaded files to the `lecture_24` directory.
...
4. Navigate (`cd`) to your `lecture_24` directory.

5. Confirm "that the contents of the `lecture_24` directory are as expected (i.e., it contains
...
1. Hover over `lecture_24.md`, right-click, and select "Open Preview".
2. Hover over `lecture_24.py`, right-click, and select "Open to the Side".
