...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_21/
cp lecture_21_setup.md lecture_21.md lecture_21.py swapi_get_test.py http_swapi.png wookieepedia_starships.csv swapi_planets.json ../Documents/umich/courses/SI506/lectures/lecture_21/
cd ../Documents/umich/courses/SI506/lectures/lecture_21/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_21`.

3. Copy (`cp`) the downloaded files to the `lecture_21` directory.
...
4. Navigate (`cd`) to your `lecture_21` directory.

5. Confirm "that the contents of the `lecture_21` directory are as expected (i.e., it contains
...
1. Hover over `lecture_21.md`, right-click, and select "Open Preview".
2. Hover over `lecture_21.py`, right-click, and select "Open to the Side".
