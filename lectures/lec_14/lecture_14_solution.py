...
def get_citation_count_by_year(publications, headers, year):
    ...
    for publication in publications:
        count += get_attribute(publication, headers, year)
    return count
...
def main():
    ...
    annual_counts = []
    for year in years:
        count = get_citation_count_by_year(publications, headers, year)
    ...
    max_count = 0
    for publication in publications:
        citation_count = get_attribute(publication, headers, 'Total Citations')
