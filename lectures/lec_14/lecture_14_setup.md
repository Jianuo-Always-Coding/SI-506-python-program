...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_14/
cp lecture_14_setup.md lecture_14.md lecture_14.py resnick-citations.csv umsi-faculty.csv ../Documents/umich/courses/SI506/lectures/lecture_14/
cd ../Documents/umich/courses/SI506/lectures/lecture_14/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_14`.

3. Copy (`cp`) the downloaded files to the `lecture_14` directory.
...
4. Navigate (`cd`) to your `lecture_14` directory.

5. Confirm "that the contents of the `lecture_14` directory are as expected (i.e., it contains
...
1. Hover over `lecture_14.md`, right-click, and select "Open Preview".
2. Hover over `lecture_14.py`, right-click, and select "Open to the Side".
