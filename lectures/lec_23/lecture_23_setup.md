...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_23/
cp lecture_23_setup.md lecture_23.md lecture_23.py lecture_23_utils.py wb-economies-2021_2022.json wb-groups-2021_2022.json wb-indicators-dict-china-2019.json wb-indicators-dict-2019.json ../Documents/umich/courses/SI506/lectures/lecture_23/
cd ../Documents/umich/courses/SI506/lectures/lecture_23/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_23`.

3. Copy (`cp`) the downloaded files to the `lecture_23` directory.
...
4. Navigate (`cd`) to your `lecture_23` directory.

5. Confirm "that the contents of the `lecture_23` directory are as expected (i.e., it contains
...
1. Hover over `lecture_23.md`, right-click, and select "Open Preview".
2. Hover over `lecture_23.py`, right-click, and select "Open to the Side".
