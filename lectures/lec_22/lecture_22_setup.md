...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_22/
cp lecture_22_setup.md lecture_22.md lecture_22.py lecture_22_utils.py speed_test.py wb-economies-2021_2022.json wb-groups-2021_2022.json ../Documents/umich/courses/SI506/lectures/lecture_22/
cd ../Documents/umich/courses/SI506/lectures/lecture_22/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_22`.

3. Copy (`cp`) the downloaded files to the `lecture_22` directory.
...
4. Navigate (`cd`) to your `lecture_22` directory.

5. Confirm "that the contents of the `lecture_22` directory are as expected (i.e., it contains
...
1. Hover over `lecture_22.md`, right-click, and select "Open Preview".
2. Hover over `lecture_22.py`, right-click, and select "Open to the Side".
