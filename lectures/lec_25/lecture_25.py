...
def create_starship(data):
    ...
    return {
        ...
        'top_speed_mglt': data.get('MGLT'),
        'crew_size': data.get('crew'),
...
def main():
    ...
    hyperdrive_ratings = None # sort with lambda expression
