...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_25/
cp lecture_25_setup.md lecture_25.md lecture_25.py five_oh_six.py episode_iv_starships.json wookieepedia_starships.csv ../Documents/umich/courses/SI506/lectures/lecture_25/
cd ../Documents/umich/courses/SI506/lectures/lecture_25/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_25`.

3. Copy (`cp`) the downloaded files to the `lecture_25` directory.
...
4. Navigate (`cd`) to your `lecture_25` directory.

5. Confirm "that the contents of the `lecture_25` directory are as expected (i.e., it contains
...
1. Hover over `lecture_25.md`, right-click, and select "Open Preview".
2. Hover over `lecture_25.py`, right-click, and select "Open to the Side".
