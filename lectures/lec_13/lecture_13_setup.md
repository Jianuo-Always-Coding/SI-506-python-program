...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_13/
cp lecture_13_setup.md lecture_13.md lecture_13.py resnick-publications.csv umsi-faculty.txt ../Documents/umich/courses/SI506/lectures/lecture_13/
cd ../Documents/umich/courses/SI506/lectures/lecture_13/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_13`.

3. Copy (`cp`) the downloaded files to the `lecture_13` directory.
...
4. Navigate (`cd`) to your `lecture_13` directory.

5. Confirm "that the contents of the `lecture_13` directory are as expected (i.e., it contains
...
1. Hover over `lecture_13.md`, right-click, and select "Open Preview".
2. Hover over `lecture_13.py`, right-click, and select "Open to the Side".
