...
``` commandline
cd Downloads
mkdir ../Documents/umich/courses/SI506/lectures/lecture_19/
cp lecture_19_setup.md lecture_19.md lecture_19.py nyt-article-research-example.json nyt-article-research-20221102.json fxt-nyt-authors.csv fxt-nyt-citations-corrected.json fxt-nyt-citations.json fxt-nyt-keyword_counts.json fxt-nyt-paleontology.csv ../Documents/umich/courses/SI506/lectures/lecture_19/
cd ../Documents/umich/courses/SI506/lectures/lecture_19/
ls
```
...
2. Create a new subdirectory directory in your SI 506 `lectures` directory named `lecture_19`.

3. Copy (`cp`) the downloaded files to the `lecture_19` directory.
...
4. Navigate (`cd`) to your `lecture_19` directory.

5. Confirm "that the contents of the `lecture_19` directory are as expected (i.e., it contains
...
1. Hover over `lecture_19.md`, right-click, and select "Open Preview".
2. Hover over `lecture_19.py`, right-click, and select "Open to the Side".
